...
# build_exe_options = {
#     "packages": ["os", "idna", "numpy", "sentence_transformers", "tqdm", "langchain"],  # Adicione quaisquer pacotes adicionais necessários
...
setup(
    ...
    executables=[Executable("./template/page.py")]  # Substitua pelo nome do seu script principal
)
